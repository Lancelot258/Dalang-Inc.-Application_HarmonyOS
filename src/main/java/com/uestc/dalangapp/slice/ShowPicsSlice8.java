...
public class ShowPicsSlice8 extends AbilitySlice implements Component.ClickedListener   {
    Button btnBack;
    @Override
    public  void  onStart(Intent intent)
    {
        super.onStart(intent);
        super.setUIContent(ResourceTable.Layout_ShowPicsSlice8);
        //setting button
        btnBack=(Button) findComponentById(ResourceTable.Id_idBtnBack_8);
        ...
        PageSlider  slider= (PageSlider) findComponentById(ResourceTable.Id_pageslider_showpic_slice_8);
