...
public class ShowPicsSlice3 extends AbilitySlice implements Component.ClickedListener   {
    Button btnBack;
    @Override
    public  void  onStart(Intent intent)
    {
        super.onStart(intent);
        super.setUIContent(ResourceTable.Layout_ShowPicsSlice3);
        //setting button
        btnBack=(Button) findComponentById(ResourceTable.Id_idBtnBack_3);
        ...
        PageSlider  slider= (PageSlider) findComponentById(ResourceTable.Id_pageslider_showpic_slice_3);
